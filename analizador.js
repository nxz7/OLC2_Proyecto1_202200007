...
function peg$parse(input, options) {
  ...
  var peg$f21 = function(ope, num) { return crearNodo('unaria', { op: ope, exp: num }) };
  var peg$f22 = function() {return parseFloat(text(), 10)};
  var peg$f23 = function() {return parseInt(text(), 10)};
  var peg$f24 = function(floatN) {return crearNodo('Primitivos', { valor: floatN, tipo: "float" })};
  var peg$f25 = function(intN) {return crearNodo('Primitivos', { valor: intN, tipo: "int" })};
  var peg$f26 = function() {return crearNodo('Primitivos', { valor: true, tipo: "boolean" })};
  var peg$f27 = function() {return crearNodo('Primitivos', { valor: false, tipo: "boolean" })};
  var peg$f28 = function(exp) { return crearNodo('agrupacion', { exp }) };
  var peg$f29 = function(exp) { return crearNodo('agrupacion', { exp }) };
  var peg$f30 = function(id) { return crearNodo('referenciaVariable', { id }) };
  var peg$f31 = function(str) { return crearNodo('Primitivos', { valor: str, tipo: "string" }) };
  var peg$f32 = function(char) { return crearNodo('Primitivos', { valor: char, tipo: "char" }) };
  var peg$f33 = function() {return crearNodo('Primitivos', { valor: null, tipo: "null" })};
