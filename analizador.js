...
function peg$parse(input, options) {
  ...
  var peg$f15 = function() {return parseInt(text(), 10)};
  var peg$f16 = function(floatN) {return crearNodo('Primitivos', { valor: floatN, tipo: "float" })};
  var peg$f17 = function(intN) {return crearNodo('Primitivos', { valor: intN, tipo: "int" })};
  var peg$f18 = function() {return crearNodo('Primitivos', { valor: true, tipo: "boolean" })};
  var peg$f19 = function() {return crearNodo('Primitivos', { valor: false, tipo: "boolean" })};
  var peg$f20 = function(exp) { return crearNodo('agrupacion', { exp }) };
  var peg$f21 = function(id) { return crearNodo('referenciaVariable', { id }) };
  var peg$f22 = function(str) { return crearNodo('Primitivos', { valor: str, tipo: "string" }) };
  var peg$f23 = function(char) { return crearNodo('Primitivos', { valor: char, tipo: "char" }) };
  var peg$f24 = function() {return crearNodo('Primitivos', { valor: null, tipo: "null" })};
